...
5. 단답형 문제는 보기를 작성하지 않아도 허용
6. mcq, short, true_false 이외의 퀴즈 유형은 거부
7. source_chunk_ids가 비어 있으면 거부
8. true_false 문제는 True 또는 False 정답을 허용
9. true_false 문제에서 True 또는 False 이외의 정답은 거부
"""
...
def test_true_false_accepts_valid_answer() -> None:
